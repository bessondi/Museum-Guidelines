    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.footer__wrapper}>
                ...
                <div className={styles.footer__wrapper__socical}>
                    <h4 className={styles.footer__wrapper_center}>
                        {/*© 2019 */}
                        Музей Фаберже
                    </h4>
                    <ul className={`${styles.footer__wrapper__socical__icons} ${styles.footer__wrapper_center}`}>
                        {
                            icons.map((icoSrc, i) =>
                                <li key={i}>
                                    <a href={links[i]}>
                                        <img className={styles.footer__wrapper__socical__icons_active}
                ...
                <div className={`${styles.footer__wrapper__contacts} ${styles.footer__wrapper_center}`}>
                    <div className={styles.footer__wrapper__contacts__mail}>
                        <p>Гайдлайны службы приема посетителей
                            <br/>
                            <a href="mailto:3332655@fsv.ru">3332655@fsv.ru</a>
                        </p>
                    </div>
                    <div className={styles.footer__wrapper__contacts__mail}>
                        <p>Верстка: Дмитрий Бессонов
                            <br/>
